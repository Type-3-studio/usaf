...
from usaf.checks.users.user_checks import EmptyPasswordCheck, RootAccountCheck, ShadowedPasswordsCheck
    ...
    def test_fails_when_extra_uid_0_user(self):
        ...
        result = check.evaluate({
            "users": {
                "users": [
                    {"username": "root", "uid": 0, "gid": 0},
                    {"username": "backdoor", "uid": 0, "gid": 0, "home": "/root", "shell": "/bin/bash"},
                ]
            }
        })
